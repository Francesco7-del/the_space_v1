...
--
-- Host: 127.0.0.1
-- Creato il: Set 24, 2021 alle 16:14
...
(1, 'xxx', 'xxxx', 'xxx@gmail.com', 'xxx', 'a1Bz20ydqelm8m1wql698d51a19d8a121ce581499d7b701668'),
(2, 'Clark', 'Banaag', 'banaaghub.com', 'clarkpogi', '111'),
(3, 'admin', 'admin', 'admin@admin.com', 'admin', 'admin'),
(6, 'ppp', 'ppp', 'pppppp@k.com', 'ppp', 'a1Bz20ydqelm8m1wqlf27f6f1c7c5cbf4e3e192e0a47b85300');
...
INSERT INTO `chat` (`id`, `firstname`, `message`, `created_on`) VALUES
(1, '', 'zz', '2021-09-22 17:20:02'),
(2, '', 'ciao a tutti\r\n', '2021-09-22 17:21:39'),
(3, '', 'x', '2021-09-22 17:22:41');
...
(132, 10, 'has logged in the system at ', '2021-09-22 23:47:45'),
(133, 6, '(Administrator) has logged in the system at ', '2021-09-23 00:03:36'),
(134, 1, '(Administrator) has logged in the system at ', '2021-09-23 00:05:02'),
(135, 10, 'has logged in the system at ', '2021-09-23 00:13:21'),
(136, 11, 'has logged in the system at ', '2021-09-23 00:31:31'),
(137, 10, 'has logged in the system at ', '2021-09-23 00:47:39'),
(138, 1, '(Administrator) has logged in the system at ', '2021-09-23 01:27:46'),
(139, 10, 'has logged in the system at ', '2021-09-23 01:34:17'),
(140, 1, '(Administrator) has logged in the system at ', '2021-09-23 01:36:13'),
(141, 10, 'has logged in the system at ', '2021-09-24 22:06:56'),
(142, 1, '(Administrator) has logged in the system at ', '2021-09-24 22:13:16');
...
(12, 'Aruino Mega', 'ATMega Arduino', 385, '133.00', '155.00', 'Arduino', 'Alcatroz, Inc.', '341156780', 'Arduinomega2560-3.jpg', 'arduino mega 2560-1.jpg', '2.png'),
...
--
-- Struttura della tabella `sales_details`
--
...
--
-- Struttura della tabella `temp_trans`
--
...
(10, 'Francesco', 'xxx', 'Cerenzia', 'Via Cav.F.Sangiovanni 4', 'cere.fra90@gmail.com', '77777', 'fra', 'a1Bz20ydqelm8m1wql698d51a19d8a121ce581499d7b701668'),
(11, 'alessandro', 'dellll', 'wwww', 'via cqva', 'wwwww', '12345', 'ale', 'a1Bz20ydqelm8m1wql698d51a19d8a121ce581499d7b701668');
...
--
-- Indici per le tabelle `sales_details`
--
...
--
-- Indici per le tabelle `temp_trans`
--
...
--
ALTER TABLE `order_details`
  MODIFY `order_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
...
--
-- AUTO_INCREMENT per la tabella `sales_details`
--
ALTER TABLE `sales_details`
...
--
-- AUTO_INCREMENT per la tabella `temp_trans`
--
ALTER TABLE `temp_trans`
