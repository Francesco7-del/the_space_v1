    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Cerenzia." data-placement="bottom" target="">
                    VR FOR ALL
                </a>
            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('./assets/img/bg8.jpg');">
                                    ...
                                    <div class="container">
                                        ...
                                        <br>
                                            ...
                                            <h3 style="color:white ">VR FOR ALL.</h3>
                                        </div>
                                    </div>
        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    <br>
                    <div class="col-md-12">
                        <h2 class="title">Look at our products</h2>
