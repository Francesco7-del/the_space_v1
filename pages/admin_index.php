    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a  style="color:white" href="admin_index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Cerenzia." data-placement="bottom" target="">
                    VR FOR ALL
                </a>
            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/bg8.jpg.');">
                ...
                <div class="container">
                    <div class="content-center brand">
                      ...
                      <h2 style="color:white">VR FOR ALL</h2>
                        <br><br>
                        <h3><h3 style="color:while">the space.</h3>
.</h3>
                    </div>
                </div>
            </div>
