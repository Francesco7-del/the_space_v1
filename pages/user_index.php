        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    ...
                    <div class="col-md-12">
                        <h2 class="title">VR experience</h2>
                        <div class="typography-line">
                            <p>
                            “ vr experience, immerse yourself in the solar system.


                            </p>
                            <h3><a href="../sistm_sol/tour.html?viewMode=cyclops" class="button" style="color:red">Start</a></h3>
                            <a href="../pages/chatpage.php" class="btn btn-primary">Open Chat</a>
                    ...
                    <!----->
                    <div class="col-md-12">
                        <h2 class="title">Quiz and description system solar</h2>
                        <div class="typography-line">
                            <p>
                            “read the description and take the quiz to learn about the solar system
                            register or log in to find out more"
                            </p>
                            ...
                            <br>
                            <br>
                            <h3><a href="../pages/desc_planet.php" class="button" style="color:red">Read description</a></h3>

                        </div>
                        <br>
                        <a href="../chatbot-/index.html" class="btn btn-primary">assistance</a>
