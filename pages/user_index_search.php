...
<body class="index-page sidebar-collapse">
    ...
    <div class="wrapper">
        <div class="page-header clear-filter" filter-color="orange">
            <div class="page-header-image" data-parallax="true" style="background-image: url('../sistm_sol/img/screen/logo_screen.png');">
                ...
                <div class="container">
                    <div class="content-center brand">
                      ...
                      <h2 style="color:black">VR FOR ALL</h2>
                        <br><br>
                        <h3><h3 style="color:black">the space.</h3>                        <br><br>
                        </div>
                </div>
            </div>
        </div>
