...
<?php
	...
	$shouts = mysqli_query($dbconn,$query);
  ...
  <body>
	...
	<div class="container">
	     ...
	     <p>Final socre: <?php echo $_SESSION['score']; ?></p>
			 ...
			 <a class="btn btn-success btn-round"href="../pages/user_index.php" class="start"><i class="now-ui-icons ui-1_simple-add"></i>HOME </a>
			 <a class="btn btn-success btn-round"href="question.php?n=1" class="start"><i class="now-ui-icons ui-1_simple-add"></i>REPEAT QUIZ  </a>
